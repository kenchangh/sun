...
tap.same(parser.parse('x = 1'), [
  new yy.LeftRight('assignment', new yy.Variable('x'), 1)
]);
...
tap.same(parser.parse('y = (5-1)*5/6+7'), [
  new yy.LeftRight('assignment', new yy.Variable('y'), 10.333333333333334)
]);
...
tap.same(parser.parse('x = 1\ny = x + 2'), [
  new yy.LeftRight('assignment', new yy.Variable('x'), 1),
  new yy.LeftRight('assignment', new yy.Variable('y'), 3),
]);

tap.same(parser.parse('x = 3\ny = x^x + 2\ny = y + 2'), [
  new yy.LeftRight('assignment', new yy.Variable('x'), 3),
  new yy.LeftRight('assignment', new yy.Variable('y'), 29),
  new yy.LeftRight('assignment', new yy.Variable('y'), 31),
]);
